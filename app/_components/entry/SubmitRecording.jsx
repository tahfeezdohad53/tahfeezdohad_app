...
function SubmitRecording({
  ...
  return (
    <div className="my-auto flex justify-between flex-col items-center lg:w-1/2 w-full lg:mx-auto bg-(--card) gap-6 order py-8 px-5 border-(--border) border h-[85vh] rounded-2xl hadow-2xl">
      <div className="flex flex-col items-center gap-3 bg-(--card) w-full py-4 rounded-2xl shadow-(--shadow-md) border border-(--border)/50">
        ...
        <div className="flex flex-col items-center">
          ...
          <p className="font-bold text-center text-amber-800 px-5">
            {" "}
            {formattedName}
          </p>
        </div>
        <p className="text-[0.65rem] text-stone-800 w-3/4 text-center">
