...
function SubmitRecording({
  ...
  return (
    <div className="my-auto flex justify-between flex-col items-center lg:w-1/2 w-full lg:mx-auto bg-(--card) gap-6 order py-8 px-5 border-(--border) h-full rounded-2xl hadow-2xl">
